...
import br.gov.serpro.bookmark.monitoring.TrapBookmark;
...
public class BookmarkBC extends DelegateCrud<Bookmark, Long, BookmarkDAO> {
	...
	@Inject
	@SNMP
	private TrapBookmark trapBookmark;
	...
	public void insert(Bookmark bean) {
		...
		//trapBookmark.avisarBookmarkCriado("Bookmark criado com sucesso!",bean.getDescription());
		
		simpleTrapper.send("Problema ao criar bookmark");
	}
